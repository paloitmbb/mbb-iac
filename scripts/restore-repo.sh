...
# Push only branches (refs/heads/*) and tags (refs/tags/*) explicitly.
# We deliberately exclude refs/pull/* — GitHub's internal PR refs captured
# by --mirror cloning — because GitHub blocks pushing them ("hidden ref").
